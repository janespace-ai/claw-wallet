...
async function loadContactsTab() {
  ...
  const agentHintHtml = `
    <div class="contacts-empty-hint" style="max-width:none;margin:12px 16px 16px;">
      <span class="contacts-empty-hint-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg></span>
