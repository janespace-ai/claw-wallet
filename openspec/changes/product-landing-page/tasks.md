...
- [x] 1.1 Clone or open `janespace-ai/janespace-ai.github.io` locally
- [x] 1.2 Create branch `feat/landing-page` from main
...
- [x] 2.1 Export Pencil screenshots from `docs/design/desktop-redesign.pen` (in claw-wallet repo):
...
- [x] 2.2 Optimize images (target < 200KB each, use `pngquant` or similar)

## 3. Root Redirect (`index.html`)

- [x] 3.1 Create `index.html` at repo root with browser language detection:
...
- [x] 4.1 Navbar — logo + EN | 中文 switcher (links to `/web/zh/`)
- [x] 4.2 Hero section
...
- [x] 4.3 "How It Works" — 4-step section
...
- [x] 4.4 Features grid — 6 cards (3×2 layout)
- [x] 4.5 Security section — architecture diagram + copy
- [x] 4.6 Footer — GitHub link, MIT license, language switcher

## 5. Chinese Landing Page (`web/zh/index.html`)

- [x] 5.1 Duplicate structure from English, translate all copy to Chinese
...
- [x] 5.2 Verify Chinese font rendering (system fonts cover CJK on all platforms)
...
- [x] 7.1 Add a "For Users" section near the top of the main `README.md` linking to `https://janespace-ai.github.io`
- [x] 7.2 Keep existing developer content below — do not replace it
